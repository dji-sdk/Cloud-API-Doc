...
[支持“任务取消”接口，允许下发飞行命令后，飞机在未起飞且RTK未收敛这段时间内，取消飞行任务。](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/dock/dock1/wayline.html)

...
* [新增内嵌 SRT 字幕信息 (含飞行器/云台姿态信息) 到视频文件中](https://developer.dji.com/doc/cloud-api-tutorial/cn/api-reference/dock-to-cloud/mqtt/dock/dock2/file.html)

...
* 告警文案查询json文件：[hms.json](https://terra-1-g.djicdn.com/71a7d383e71a4fb8887a310eb746b47f/cloudapi/hms.json)。
...
### 告警文案填充
从告警文案查询json文件：[hms.json](https://terra-1-g.djicdn.com/71a7d383e71a4fb8887a310eb746b47f/cloudapi/hms.json)中可以看到，查询得到的告警文案中会存在"%alarmid"、"%index"等需要填充的内容。

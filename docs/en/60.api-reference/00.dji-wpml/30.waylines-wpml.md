...
| wpml:globalTransitionalSpeed | global transitional speed                          | float | m/s  | > 0<br/>*Note: The speed at which the drone flies to the first waypoint of each waylines. The speed at which the drone resumes from its current position to the break point when the waylines mission is interrupted.* | Yes                      | M300 RTK, M350 RTK, M30/M30T, M3E/M3T/M3M |

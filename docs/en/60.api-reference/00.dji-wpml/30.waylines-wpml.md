...
| wpml:takeOffSecurityHeight   | Safe take-off height                               | float | m    | [2, 1500] (height mode: height relative to take-off point)<br/> *Note: After take-off, the aircraft will ascend to this altitude and then fly to the first waypoint according to the "Fly to first waypoint mode" setting. This element is only valid when the aircraft is not taking off.* | Yes                      | M300 RTK, M350 RTK, M30/M30T, M3E/M3T/M3M, M3D/M3TD         |

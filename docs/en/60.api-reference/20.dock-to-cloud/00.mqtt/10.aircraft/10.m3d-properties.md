...
|---|---|---|---|---|---|---|
|best_link_gateway|The gateway with the best aircraft image transmission connection quality SN|text| |In the multi-dock scenario, after the aircraft frequency matches with two docks, the SN of the best connected dock is pushed|r|1|
...
|»center_node|Aircraft frequency matching information|struct| |||0|
|»»sdr_id|Scrambling code information|int| |||0|
|»»sn|Device SN|text| |||0|
|»leaf_nodes|Current connection dock or remote controller frequency matching information|array| {"size": -, "item_type": struct} |||0|
|»»sdr_id|Scrambling code information|int| |||0|
|»»sn|Device SN|text| |||0|

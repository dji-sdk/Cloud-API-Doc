...
<table width="100%" style="display: table; table-layout:fixed;">
    ...
    <tbody>
        ...
        <tr>
            <td>312015</td>
            <td>Aircraft enhanced transmission enabled. Failed to update firmware. Disable enhanced transmission, restart device, and try again</td>
        </tr>
        <tr>
            <td>312016</td>

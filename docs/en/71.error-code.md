...
<tbody>
    ...
    <tr>
        <td>324030</td>
        <td>Issues such as dock network or aircraft image transmission error occurred. Unable to temporarily upload media files to cloud or files were uploaded but upload status unknown by cloud.</td>
    </tr>
    <tr>
        <td>513001</td>

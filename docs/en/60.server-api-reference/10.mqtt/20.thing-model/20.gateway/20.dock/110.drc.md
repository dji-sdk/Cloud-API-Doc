...
## Enter the command flight control mode
...
## Exit the command flight control mode
...
After the command flight control mode is entered, this command is allowed to control the drrone flight direction and speed. The sending frequency should be maintained from **5 to 10 HZ**. Therefore the speed and direction can be controlled precisely.

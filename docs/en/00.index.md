...
* [Added embedding of SRT subtitle information (including aircraft/gimbal attitude information) into video files](https://developer.dji.com/doc/cloud-api-tutorial/en/api-reference/dock-to-cloud/mqtt/dock/dock2/file.html).
...
<table width="100%" style="display: table; table-layout:fixed;">
    ...
    <tr>
        <td>Mavic 3E/3T</td>
        <td rowspan= 2>Please wait for a later firmware version.</td>
    </tr>
    <tr>
...
<table width="100%" style="display: table; table-layout:fixed;">
    ...
    <tr>
        <td>DJI RC Pro Enterprise</td>
        <td>Please wait for a later firmware version.</td>
    </tr>
    <tr>
        <td>DJI Dock 2</td>
        <td>10.01.16.04</td>

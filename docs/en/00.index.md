...
* Server API > MQTT:
  * [Wayline Management: added `pause wayline task`, `resume wayline task` and `resume flight from breakpoint`.](https://developer.dji.com/doc/cloud-api-tutorial/en/server-api-reference/mqtt/thing-model/gateway/dock/wayline.html)

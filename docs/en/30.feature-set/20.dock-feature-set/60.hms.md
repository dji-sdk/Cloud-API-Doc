...
* Alarm copy query json file: [hms.json](https://terra-1-g.djicdn.com/71a7d383e71a4fb8887a310eb746b47f/cloudapi/hms.json)
...
Based on the alarm copy query json file: [hms.json](https://terra-1-g.djicdn.com/71a7d383e71a4fb8887a310eb746b47f/cloudapi/hms.json), there are some words like "%alarmid", "%index" needs to be replaced.
